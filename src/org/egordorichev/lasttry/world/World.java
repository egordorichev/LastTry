...
public class World {
	...
	private void generate() {
		...
		if(LastTry.random.nextBoolean()) {
			this.evil = Evil.CORRUPTION;
		} else {
			this.evil = Evil.CRIMSON;
		}
	...
	private void load() {
		try {
			...
			this.evil = (stream.readBoolean()) ? Evil.CRIMSON : Evil.CORRUPTION;
	...
	public void save() {
		...
		stream.writeBoolean((this.evil == Evil.CRIMSON) ? true : false);
