...
public class World {
	...
	private void generate() {
		...
		if (LastTry.random.nextBoolean()) {
			this.evilType = EvilType.CORRUPTION;
		} else {
			this.evilType = EvilType.CRIMSON;
		}
	...
	private void load() {
		try {
			...
			this.evilType = (stream.readBoolean()) ? EvilType.CRIMSON : EvilType.CORRUPTION;
	...
	public void save() {
		...
		stream.writeBoolean((this.evilType == EvilType.CRIMSON) ? true : false);
