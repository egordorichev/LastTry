...
public class ChunkData {
	...
	public ChunkData() {
		this.blocks = new short[Chunk.SIZE * Chunk.SIZE];
		this.blocksHealth = new byte[Chunk.SIZE * Chunk.SIZE];
		this.walls = new short[Chunk.SIZE * Chunk.SIZE];
		this.wallsHealth = new byte[Chunk.SIZE * Chunk.SIZE];
	}
}