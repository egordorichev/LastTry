...
public class BlueSlime extends Slime {
    public BlueSlime() {
        super(EnemyID.blueSlime, "Blue Slime", LastTry.world.flags.isExpertMode() ? 10 : 10, 2, LastTry.world.flags.isExpertMode() ? 7 : 14, Assets.getTexture(Textures.blueSlime));
