...
public class Debug {
    ...
    public void render() {
	    ...
	    Assets.f18.draw(Graphics.batch, "X: " + String.format("%d", Globals.player.physics.getGridX())
            + " Y: " + String.format("%d", Globals.player.physics.getGridY()), 10, 50);
	    Assets.f18.draw(Graphics.batch, "Total amount of enemies: "+ Globals.entityManager.getEnemyEntities().size(), 10, 70);
	    Assets.f18.draw(Graphics.batch, "Current Biome: "+ Globals.environment.currentBiome.getName(), 10, 90);
	    Assets.f18.draw(Graphics.batch, "Current world time: "+ Globals.environment.time.toString(true), 10, 110);
        ...
        Assets.f18.draw(Graphics.batch, message, 10, 130);
